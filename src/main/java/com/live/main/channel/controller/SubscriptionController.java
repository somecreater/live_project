...
public class SubscriptionController {
  ...
  public ResponseEntity<?> subscriptionCheck(
    ...
    SubscriptionDto check= channelService.checkSubscription(principal.getUserid(), channel_name);
    if(check != null){
      result.put("result",true);
      result.put("is_subscription",true);
      result.put("subscription", check);
    }else{
      result.put("result",true);
      result.put("is_subscription", false);
    }
