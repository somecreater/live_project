...
export const API_END_POINT = {
  ...
  video: {
    ...
    multipart_upload_url_request: `${API_BASE_URL}/api/video/multipart-upload-url-request`,
    ...
    get_video: `${API_BASE_URL}/api/video`,
    get_video_playlist: `${API_BASE_URL}/api/video`,
